  ...
  handler: async (args: Record<string, unknown>, _pipeline: RAGPipeline) => {
    ...
    const judgedResults = results.map((result) => {
      ...
      for (const criterion of criteria) {
        ...
        scores[criterion] = Number.parseFloat(baseScore.toFixed(3));
      }
      ...
      return {
        ...
        scores,
        overall_score: Number.parseFloat(overallScore.toFixed(3)),
      };
    });
          ...
          text: JSON.stringify(
            {
              ...
              consensus_score: Number.parseFloat(consensusScore.toFixed(3)),
          ...
          text: JSON.stringify(
            {
              ...
              passed,
              validations,
              quality_score: Number.parseFloat(qualityScore.toFixed(3)),
          ...
          text: JSON.stringify(
            {
              ...
              confidence: Number.parseFloat(supportScore.toFixed(3)),
              support_score: Number.parseFloat(supportScore.toFixed(3)),
          ...
          text: JSON.stringify(
            {
              ...
              passed,
              metrics: {
                avg_relevance: Number.parseFloat(avgRelevance.toFixed(3)),
                avg_completeness: Number.parseFloat(avgCompleteness.toFixed(3)),
                hallucination_rate: Number.parseFloat(hallucinationRate.toFixed(3)),
              },
              thresholds: {
