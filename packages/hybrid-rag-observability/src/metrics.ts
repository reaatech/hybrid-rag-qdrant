...
export class MetricsCollector {
   ...
   */
  recordRetrievalResults(count: number, source = 'hybrid'): void {
   ...
   */
  recordRerankerCall(provider: string, cost = 0): void {
   ...
   */
  recordEmbeddings(count: number, provider: string, cost = 0): void {
